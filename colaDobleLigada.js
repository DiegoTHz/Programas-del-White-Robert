...
let colaDobleLigada = new ColaDobleLigada();
...
function actualizarDisplay() {
    ...
    if (colaDobleLigada.isEmpty()) {
        contenedorCola.innerHTML = '<div class="null">NULL ← FRONT | BACK → NULL</div>';
        return;
    }

    const elementos = colaDobleLigada.toArray();
...
document.getElementById('agregarFrente').addEventListener('click', () => {
    ...
    colaDobleLigada.agregarFrente(dato);
...
document.getElementById('agregarFinal').addEventListener('click', () => {
    ...
    colaDobleLigada.agregarFinal(dato);
    document.getElementById('dato').value = '';
...
document.getElementById('btnEliminarFrente').addEventListener('click', () => {
    ...
    const datoEliminado = colaDobleLigada.eliminarFrente();
...
document.getElementById('btnEliminarFinal').addEventListener('click', () => {
    ...
    const datoEliminado = colaDobleLigada.eliminarFinal();
...
document.getElementById('btnLimpiar').addEventListener('click', () => {
    colaDobleLigada = new ColaDobleLigada();
    document.getElementById('dato').value = '';
